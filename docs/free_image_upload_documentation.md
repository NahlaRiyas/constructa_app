...
```mermaid
flowchart TD
    A["Constructor / User Device"] -->|"Selects 1 to N Images"| B["Gallery or Camera (ImagePicker)"]
    B --> C["Client-Side Compression Engine\n(flutter_image_compress)"]
    C -->|"Adaptive Quality Loop"| D{"File Size ≤ 3MB?"}
    D -- No --> C
    D -- Yes --> E["ImgBB REST API\n(HTTP Multipart POST)"]
    E -->|"Upload with API Key"| F["ImgBB CDN Cluster"]
    F -->|"Returns Direct CDN URL\nhttps://i.ibb.co/..."| G["Constructa Service Layer\n(media_upload_service.dart)"]
    G -->|"Save URLs to Document"| H["Cloud Firestore\n('projects', 'house_plans', 'users', 'companies')"]
    H -->|"Real-Time Snapshot Stream"| I["All App Modules"]
    I --> J["Constructor Portal\n(Edit / Manage)"]
    I --> K["User Portal\n(Carousel & Gallery Viewer)"]
    I --> L["Admin Portal\n(Inspection Modal & Viewer)"]
```
...
Defined in [api_constants.dart](file:///Users/olivodeveloper/flutter%20apps/constructa_app/lib/core/constants/api_constants.dart):
...
Implemented in [media_upload_service.dart](file:///Users/olivodeveloper/flutter%20apps/constructa_app/lib/core/services/media_upload_service.dart).
...
In [add_edit_project_screen.dart](file:///Users/olivodeveloper/flutter%20apps/constructa_app/lib/modules/constructor/screens/add_edit_project_screen.dart), when the constructor saves a project:
...
In [ConstructorProfileScreen](file:///Users/olivodeveloper/flutter%20apps/constructa_app/lib/modules/constructor/screens/constructor_profile_screen.dart) and [ConstructorDashboardScreen](file:///Users/olivodeveloper/flutter%20apps/constructa_app/lib/modules/constructor/screens/constructor_dashboard_screen.dart), real-time Firestore listeners keep UI elements perfectly in sync:
...
In [fullscreen_image_viewer.dart](file:///Users/olivodeveloper/flutter%20apps/constructa_app/lib/core/common/utils/fullscreen_image_viewer.dart):
