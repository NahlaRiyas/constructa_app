...
class _RateReviewScreenState extends State<RateReviewScreen> {
  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      // Ensure we have a valid name even if displayName isn't synced yet
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Rate & Review', style: GoogleFonts.poppins(color: AppColors.textPrimary, fontWeight: FontWeight.bold, fontSize: 17)),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(headingPrefix, style: GoogleFonts.poppins(fontSize: 14, color: AppColors.textSecondary)),
            const SizedBox(height: 4),
            Text(widget.targetTitle, textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.primary)),
            if (widget.targetType != 'company') ...[
              const SizedBox(height: 4),
              Text('by ${widget.companyName}', style: GoogleFonts.poppins(fontSize: 13, color: AppColors.textSecondary)),
            ],
